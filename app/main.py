...
def cli_main():
    ...
    parser.add_argument("--style", help="CSS style file from themes folder")
    parser.add_argument("--generate-thumbnails", action="store_true", help="Generate thumbnail previews")
